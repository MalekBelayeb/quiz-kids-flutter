...
import 'package:quiz_flutter/Screens/QuizSportCards.dart';
...
class QuizSport extends StatefulWidget {
  static String tag = '/QuizSport';
  late int index;
  QuizSport({Key? key, required this.index}) : super(key: key);
  @override
  _QuizSportState createState() => _QuizSportState();
}

class _QuizSportState extends State<QuizSport> {
