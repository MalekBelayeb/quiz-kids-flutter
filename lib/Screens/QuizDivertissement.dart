...
import 'package:quiz_flutter/Screens/QuizDivertissementCards.dart';
...
class QuizDivertissement extends StatefulWidget {
  static String tag = '/QuizDivertissement';
  late int index;
  QuizDivertissement({Key? key, required this.index}) : super(key: key);
  @override
  _QuizDivertissementState createState() => _QuizDivertissementState();
}

class _QuizDivertissementState extends State<QuizDivertissement> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          quizButton(
              ...
              onPressed: () {
                QuizDivertissementCards().launch(context);
              })
        ],
      ),
    );
