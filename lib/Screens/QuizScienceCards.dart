...
class QuizScienceCards extends StatefulWidget {
  static String tag = '/QuizScienceCards';

  @override
  _QuizScienceCardsState createState() => _QuizScienceCardsState();
}

class _QuizScienceCardsState extends State<QuizScienceCards> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz("Science", "Eight Steps", "Ten Steps", "Two Steps", "One Steps",
          70.0),
    );
    planetCard.add(
