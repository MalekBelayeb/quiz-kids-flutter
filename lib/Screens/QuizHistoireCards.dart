...
class QuizHistoireCards extends StatefulWidget {
  static String tag = '/QuizHistoireCards';

  @override
  _QuizHistoireCardsState createState() => _QuizHistoireCardsState();
}

class _QuizHistoireCardsState extends State<QuizHistoireCards> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz("HISTOIRE", "Eight Steps", "Ten Steps", "Two Steps", "One Steps",
          70.0),
    );
    planetCard.add(
