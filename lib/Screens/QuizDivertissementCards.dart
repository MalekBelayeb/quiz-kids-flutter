...
class QuizDivertissementCards extends StatefulWidget {
  static String tag = '/QuizDivertissementCards';

  @override
  _QuizDivertissementCardsState createState() =>
      _QuizDivertissementCardsState();
}

class _QuizDivertissementCardsState extends State<QuizDivertissementCards> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz("DIV", "Eight Steps", "Ten Steps", "Two Steps", "One Steps", 70.0),
    );
    planetCard.add(
