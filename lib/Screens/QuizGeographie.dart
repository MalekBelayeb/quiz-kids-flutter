...
import 'package:quiz_flutter/Screens/QuizGeographieCards.dart';
...
class QuizGeographie extends StatefulWidget {
  static String tag = '/QuizGeographie';
  late int index;
  QuizGeographie({Key? key, required this.index}) : super(key: key);
  @override
  _QuizGeographieState createState() => _QuizGeographieState();
}

class _QuizGeographieState extends State<QuizGeographie> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          quizButton(
              ...
              onPressed: () {
                QuizGeographieCards().launch(context);
              })
        ],
      ),
    );
