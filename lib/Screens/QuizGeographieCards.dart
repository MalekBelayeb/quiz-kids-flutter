...
class QuizGeographieCards extends StatefulWidget {
  static String tag = '/QuizGeographieCards';

  @override
  _QuizGeographieCardsState createState() => _QuizGeographieCardsState();
}

class _QuizGeographieCardsState extends State<QuizGeographieCards> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz("gEO", "Eight Steps", "Ten Steps", "Two Steps", "One Steps", 70.0),
    );
    planetCard.add(
