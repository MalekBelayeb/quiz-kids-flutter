...
class QuizArtCardsExpers extends StatefulWidget {
  static String tag = '/QuizArtCardsExpers';

  @override
  _QuizArtCardsExpersState createState() => _QuizArtCardsExpersState();
}

class _QuizArtCardsExpersState extends State<QuizArtCardsExpers> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz(" Expers", "Mona Lisa", "École d'Athènes", "La création d'Adam",
