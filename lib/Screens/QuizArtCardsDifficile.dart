...
class QuizArtCardsDifficile extends StatefulWidget {
  static String tag = '/QuizArtCardsDifficile';

  @override
  _QuizArtCardsDifficileState createState() => _QuizArtCardsDifficileState();
}

class _QuizArtCardsDifficileState extends State<QuizArtCardsDifficile> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz(" Difficile", "Mona Lisa", "École d'Athènes", "La création d'Adam",
          'La Jeune Fille à la perle', 70.0),
    );
