...
class QuizSportCards extends StatefulWidget {
  static String tag = '/QuiSportzCards';

  @override
  _QuizSportCardsState createState() => _QuizSportCardsState();
}

class _QuizSportCardsState extends State<QuizSportCards> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz(
          "Sport?", "Eight Steps", "Ten Steps", "Two Steps", "One Steps", 70.0),
    );
    planetCard.add(
