...
class QuizArtCardsMoyen extends StatefulWidget {
  static String tag = '/QuizArtCardsMoyen';

  @override
  _QuizArtCardsMoyenState createState() => _QuizArtCardsMoyenState();
}

class _QuizArtCardsMoyenState extends State<QuizArtCardsMoyen> {
  ...
  List<Widget> _generateCards() {
    ...
    planetCard.add(
      Quiz(" Moyen", "Mona Lisa", "École d'Athènes", "La création d'Adam",
