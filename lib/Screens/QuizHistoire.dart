...
import 'package:quiz_flutter/Screens/QuizHistoireCards.dart';
...
class QuizHistoire extends StatefulWidget {
  static String tag = '/QuizHistoire';
  late int index;
  QuizHistoire({Key? key, required this.index}) : super(key: key);
  @override
  _QuizHistoireState createState() => _QuizHistoireState();
}

class _QuizHistoireState extends State<QuizHistoire> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          quizButton(
              ...
              onPressed: () {
                QuizHistoireCards().launch(context);
              })
        ],
      ),
    );
